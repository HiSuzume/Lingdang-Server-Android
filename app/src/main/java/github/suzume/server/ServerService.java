...
import github.suzume.foreground.service.ForegroundService;
...
public class ServerService extends ForegroundService {
    ...
    public void onCreate() {
        ...
        try {
            ...
            server.setFileListEnabled(sd.get("http_filelist","假").equals("真"));
            server.start();
        } catch (Exception e) {
    ...
    @Override
    public void onCreateForegroundNotification() {
        createForeground(
            "Suzume Server",
            "行ってきます",
            "铃铛 前台服务",
